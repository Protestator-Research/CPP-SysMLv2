...
%type <str> comment_option from_option prefix_metadata_annotation type_prefix qualified_name qualified_name_tail identification mutliplicity_bounds specialization_option conjugation_option type_body;
...
%%
    ...
    superclassing_conjunction_option: superclassing_part | conjunction_option | /*empty*/;
    ...
    | all_modifier conjungation_part feature_relationship_part_option;
    ...
    feature_specialization_conjungation_option: feature_specialization_part | conjungation_part | /* empty */;
    ...
    feature_specialization_option: typings | subsettings | references | redefinitions | /*empty*/;
